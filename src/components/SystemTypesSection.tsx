          ...
          {systemCards.map((card) => {
            return (
              <article
                key={card.id}
                id={card.id}
                className="flex h-full scroll-mt-28 flex-col rounded-[20px] border border-[#E6EDF4] bg-[#F4F8FB] p-4 text-left transition duration-300 ease-out hover:-translate-y-1.5 hover:shadow-[0_18px_40px_rgba(15,23,42,0.12)] sm:p-5"
              >
